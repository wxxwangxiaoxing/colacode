...
| 表名 | 说明 | 关键字段 |
|------|------|----------|
| auth_user | 用户信息 | user_name, nick_name, password |
| auth_role | 角色 | role_name, role_key |
| auth_permission | 权限 | name, permission_key, type(菜单/操作) |
| auth_user_role | 用户-角色关联 | user_id, role_id |
| auth_role_permission | 角色-权限关联 | role_id, permission_id |
